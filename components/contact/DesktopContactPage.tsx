...
import { contactPage as contactPageDefinition } from "@/components/content/contact";

type DesktopContactPageProps = {
  content: typeof contactPageDefinition;
};

export default function DesktopContactPage({
  content,
}: DesktopContactPageProps) {
