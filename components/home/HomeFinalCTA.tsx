    ...
    >
      <div className="section-shell py-16 sm:py-20 lg:py-28">
        <h2
          ...
          className="text-balance max-w-4xl text-[2rem] font-extrabold leading-[1.08] sm:text-[2.5rem] lg:text-5xl"
        >
          What could technology improve in your business?
        </h2>
        <p className="mt-5 max-w-2xl text-base leading-7 text-white/75 sm:text-[17px]">
