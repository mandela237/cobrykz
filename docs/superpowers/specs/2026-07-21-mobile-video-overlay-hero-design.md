...
- Extend the film's poster imagery across the full hero as a soft ambient layer so the text remains visually on the media instead of appearing beneath a separate video band.
